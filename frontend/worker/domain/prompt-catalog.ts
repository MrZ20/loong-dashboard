...
只根据当前本地 Agent Session 可读取的 vLLM/vLLM-Ascend worktree、受限 Git 查询和显式页面上下文回答。
...
export const PROMPT_CATALOG: readonly PromptDefinition[] = [
  {
    ...
    systemContract: PR_SUMMARY_SYSTEM_CONTRACT, promptVersion: ANALYSIS_PROMPT_VERSIONS.prSummary,
  },
  {
    ...
    systemContract: ISSUE_SUMMARY_SYSTEM_CONTRACT, promptVersion: ANALYSIS_PROMPT_VERSIONS.issueSummary,
  },
  {
    ...
    systemContract: PR_DEEP_ANALYSIS_SYSTEM_CONTRACT, promptVersion: ANALYSIS_PROMPT_VERSIONS.prDeepAnalysis,
  },
  {
    ...
    systemContract: ISSUE_DEEP_ANALYSIS_SYSTEM_CONTRACT, promptVersion: ANALYSIS_PROMPT_VERSIONS.issueDeepAnalysis,
  },
  {
    ...
    systemContract: buildClassificationSystemPrompt(VLLM_TAXONOMY), promptVersion: VLLM_TAXONOMY.version,
  },
  {
    ...
    systemContract: buildClassificationSystemPrompt(VLLM_ASCEND_TAXONOMY), promptVersion: VLLM_ASCEND_TAXONOMY.version,
  },
  {
    ...
    systemContract: buildTaxonomyRefreshSystemPrompt(VLLM_TAXONOMY), promptVersion: `${VLLM_TAXONOMY.version}-refresh-v1`,
  },
  {
    ...
    systemContract: buildTaxonomyRefreshSystemPrompt(VLLM_ASCEND_TAXONOMY), promptVersion: `${VLLM_ASCEND_TAXONOMY.version}-refresh-v1`,
  },
  {
    key: "daily_report", name: "仓库今日分析", group: "分析文档",
    description: "控制每个仓库北京时间自然日的 Markdown 社区日报。",
    contextSources: ["当日 PR/Issue 事件", "领域活动", "状态变化"],
    systemContract: DOCUMENT_CONTRACT, promptVersion: "daily-report-v2",
  },
  {
    ...
    systemContract: DOMAIN_ARCHITECTURE_MAP_SYSTEM_CONTRACT, promptVersion: "domain-architecture-map-v2",
  },
  {
  ...
  },
  {
    ...
    contextSources: ["两仓库 PR/Issue", "关注列表", "跨仓库影响", "领域活动"],
    systemContract: DOCUMENT_CONTRACT, promptVersion: "cross-repo-insight-v2",
  },
  {
    key: "local_code_insight", name: "本地代码证据洞察", group: "分析文档",
    description: "AI 洞察显式启用本地只读 Agent 后，控制本地代码证据如何进入最终文档。",
    contextSources: ["用户选择的社区事项", "Runner 结构化事件", "代码引用", "Commit SHA"],
    systemContract: LOCAL_CODE_INSIGHT_CONTRACT, promptVersion: "local-code-insight-v2",
  },
  {
    key: "chat_assistant", name: "AI 对话助手", group: "交互助手",
    description: "控制普通对话页与悬浮窗口的助手回答方式。",
    contextSources: ["最近对话", "当前页面", "网页选中文本"],
    ...
    promptVersion: "chat-assistant-v2",
  },
  {
    key: "repository_code_chat", name: "仓库分析对话", group: "交互助手",
    description: "显式仓库分析模式下，控制本地 Agent 只读检索与连续代码问答。",
    contextSources: ["选择的仓库", "Branch / Commit", "本地 Agent Session", "历史代码引用", "网页选中文本"],
    systemContract: REPOSITORY_CHAT_CONTRACT, promptVersion: "repository-code-chat-v1",
  },
] as const;
